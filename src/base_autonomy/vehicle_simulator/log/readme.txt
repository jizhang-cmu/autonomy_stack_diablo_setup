Exploration metrics, vehicle trajectory, and point cloud are saved in this folder.
...
'pointcloud_xxx.txt' contains five columns, respectively x (m), y (m), z (m), intensity, and time duration from start of the run (second).
